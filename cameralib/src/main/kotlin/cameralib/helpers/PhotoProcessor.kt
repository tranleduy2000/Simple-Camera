...
class PhotoProcessor(
    ...
    val mediaSavedListener: MediaSavedListener,
    val saveUri: Uri?, val deviceOrientation: Int, val previewRotation: Int, val isUsingFrontCamera: Boolean,
    ...
    override fun onPostExecute(path: String) {
        ...
        if (path.isNotEmpty()) {
            mediaSavedListener.mediaSaved(path)
        }
    }
